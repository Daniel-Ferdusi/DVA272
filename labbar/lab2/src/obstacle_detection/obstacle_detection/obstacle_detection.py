...
class ObstacleDetection(Node):
    ...
    def detect_obstacle(self):
        ...
        - Each value represents d                                                        istance at a different angle around the robot
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        if not valid_ranges:
            ...
            x_obstacle = d * math.cos(angle)
            y_obstacle = d * math.sin(angle)
    ...
    def odom_callback(self, msg: Odometry):
        ...
        q = msg.pose.pose.orientation_, _, self.theta = euler_from_quaternion([q.x, q.y, q.z, q.w])
